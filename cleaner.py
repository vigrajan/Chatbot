...
# This code looks at patterns like date time stamp, hyphen & usernames in the chat text & filters them from the chat. The end result is a chat processor that filters the above
